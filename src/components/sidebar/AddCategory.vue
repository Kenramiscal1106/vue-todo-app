...
<template>
  <button
    class="rounded-md flex items-center gap-1 px-2 py-1 bg-accent hover:bg-accent-hover text-left text-white group">
    <svg width="20" height="20" viewBox="0 0 20 20" class="group-hover:scale-125" fill="none"
